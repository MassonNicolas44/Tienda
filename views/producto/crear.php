...
<form action="<?= $URLaccion ?>" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" name="nombre" style="width: 400px;"
        value="<?= isset($traerProducto) && is_object($traerProducto) ? $traerProducto->nombre : ''; ?>"> </br>

    <label>Descripcion</label> </br>
    <textarea name="descripcion"
        style="width: 400px;"> <?= isset($traerProducto) && is_object($traerProducto) ? $traerProducto->descripcion : ''; ?></textarea>
    </br> </br>

    <label>Precio</label> </br>
    <input type="number" name="precio" style="width: 400px;"
        value="<?= isset($traerProducto) && is_object($traerProducto) ? $traerProducto->precio : ''; ?>"> </br> </br>

    <label>Stock</label> </br>
    <input type="number" name="stock" style="width: 400px;"
        value="<?= isset($traerProducto) && is_object($traerProducto) ? $traerProducto->stock : ''; ?>"> </br> </br>
